...
package pi_pa_mehdi.master_job_0_1;
...
/**
 * Job: Master_Job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class Master_Job implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Master_Job";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Master_Job.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		pi_pa_mehdi.atl_dim_geographie_0_1.ATL_Dim_Geographie childJob_tRunJob_1 = new pi_pa_mehdi.atl_dim_geographie_0_1.ATL_Dim_Geographie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		pi_pa_mehdi.etl_dim_categorie_0_1.ETL_Dim_Categorie childJob_tRunJob_2 = new pi_pa_mehdi.etl_dim_categorie_0_1.ETL_Dim_Categorie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_10 = null;
		...
		pi_pa_mehdi.etl_dictionnaire_geographie_0_1.ETL_Dictionnaire_Geographie childJob_tRunJob_10 = new pi_pa_mehdi.etl_dictionnaire_geographie_0_1.ETL_Dictionnaire_Geographie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		pi_pa_mehdi.etl_dim_client_0_1.ETL_Dim_Client childJob_tRunJob_3 = new pi_pa_mehdi.etl_dim_client_0_1.ETL_Dim_Client();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		pi_pa_mehdi.etl_dim_fournisseurs_0_1.ETL_Dim_Fournisseurs childJob_tRunJob_4 = new pi_pa_mehdi.etl_dim_fournisseurs_0_1.ETL_Dim_Fournisseurs();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		pi_pa_mehdi.etl_dim_mode_paimement_0_1.ETL_Dim_Mode_Paimement childJob_tRunJob_5 = new pi_pa_mehdi.etl_dim_mode_paimement_0_1.ETL_Dim_Mode_Paimement();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		pi_pa_mehdi.etl_dim_produits_0_1.ETL_Dim_Produits childJob_tRunJob_6 = new pi_pa_mehdi.etl_dim_produits_0_1.ETL_Dim_Produits();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_9 = null;
		...
		pi_pa_mehdi.el_dictionnaire_categorie_0_1.EL_Dictionnaire_Categorie childJob_tRunJob_9 = new pi_pa_mehdi.el_dictionnaire_categorie_0_1.EL_Dictionnaire_Categorie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_7 = null;
		...
		pi_pa_mehdi.etl_fact_vente2_0_1.ETL_Fact_Vente2 childJob_tRunJob_7 = new pi_pa_mehdi.etl_fact_vente2_0_1.ETL_Fact_Vente2();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_8 = null;
		...
		pi_pa_mehdi.etl_fact_achat_0_1.ETL_Fact_Achat childJob_tRunJob_8 = new pi_pa_mehdi.etl_fact_achat_0_1.ETL_Fact_Achat();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final Master_Job Master_JobClass = new Master_Job();

        int exitCode = Master_JobClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Master_Job.class.getClassLoader().getResourceAsStream("pi_pa_mehdi/master_job_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Master_Job.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Master_Job");
        }
...
/************************************************************************************************
 *     94245 characters generated by Talend Open Studio for Data Integration 
