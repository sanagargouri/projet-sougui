...
package pi_basana.depenses_fournisseur_0_1;
...
/**
 * Job: Depenses_Fournisseur Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Depenses_Fournisseur implements TalendJob {
	...
	private final String jobName = "Depenses_Fournisseur";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Depenses_Fournisseur.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Depenses_Fournisseur.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_Depenses_Fournisseur = new byte[0];
		static byte[] commonByteArray_PI_BASANA_Depenses_Fournisseur = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_Depenses_Fournisseur.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_Depenses_Fournisseur.length == 0) {
						commonByteArray_PI_BASANA_Depenses_Fournisseur = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_Depenses_Fournisseur = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_Depenses_Fournisseur, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_Depenses_Fournisseur, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_Depenses_Fournisseur, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_Depenses_Fournisseur, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_Depenses_Fournisseur) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:hP0DVw1hgRIcbcRUKq2jo86OhAm+hNL8Zve8h3UDln55izrA");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "Depenses_Fournisseur";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Depenses_Fournisseur";
				}
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:uod9LMx2t4PYsvc6X1E4SmqKlNwlFcTrNyZTLA==");
...
// Start of branch "row1"
	...
	public static void main(String[] args) {
		final Depenses_Fournisseur Depenses_FournisseurClass = new Depenses_Fournisseur();

		int exitCode = Depenses_FournisseurClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Depenses_Fournisseur.class.getClassLoader()
					.getResourceAsStream("pi_basana/depenses_fournisseur_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Depenses_Fournisseur.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Depenses_Fournisseur");
		}
...
/************************************************************************************************
 * 59480 characters generated by Talend Open Studio for Data Integration on the
 * 9 février 2026 à 21:34:41 CET
 ************************************************************************************************/