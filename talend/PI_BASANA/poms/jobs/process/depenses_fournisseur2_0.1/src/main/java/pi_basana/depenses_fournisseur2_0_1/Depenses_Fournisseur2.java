...
package pi_basana.depenses_fournisseur2_0_1;
...
/**
 * Job: Depenses_Fournisseur2 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Depenses_Fournisseur2 implements TalendJob {
	...
	private final String jobName = "Depenses_Fournisseur2";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Depenses_Fournisseur2.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Depenses_Fournisseur2.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_Depenses_Fournisseur2 = new byte[0];
		static byte[] commonByteArray_PI_BASANA_Depenses_Fournisseur2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_Depenses_Fournisseur2.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_Depenses_Fournisseur2.length == 0) {
						commonByteArray_PI_BASANA_Depenses_Fournisseur2 = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_Depenses_Fournisseur2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_Depenses_Fournisseur2, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_Depenses_Fournisseur2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_Depenses_Fournisseur2, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_Depenses_Fournisseur2, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_Depenses_Fournisseur2) {
				...
				try {
					...
					this.Fournisseur1 = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Fournisseur1, dos);
		...
		public String toString() {
			...
			sb.append(",Fournisseur1=" + Fournisseur1);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:djPzst2I0td4t6borhp8BMpFN0ho8/gwtFYfhnwCXqutBDNJ");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "Depenses_Fournisseurs";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "Depenses_Fournisseurs";
				}
				int count_tDBOutput_1 = 0;

				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([Fournisseur] VARCHAR(255)  ,[Facture] VARCHAR(255)  ,[Date] VARCHAR(255)  ,[Montant] VARCHAR(255)  ,[Fournisseur1] VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Fournisseur],[Facture],[Date],[Montant],[Fournisseur1]) VALUES (?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:iX0xJMWV+c1E9LQ61SMEPKXyKNQce45RkuCjZg==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/eree/Desktop/wetransfer_artisanat-zip_2026-01-21_0929/artisanat/artisanat/Bilan/Bilan Fournisseurs.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_1.addAll(
							regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Dépenses", false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "Fournisseur";

									row1.Fournisseur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Facture";

									row1.Facture = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Facture = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Montant";

									row1.Montant = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Montant = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Fournisseur1";

									row1.Fournisseur1 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Fournisseur1 = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.Fournisseur == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, row1.Fournisseur);
								}

								if (row1.Facture == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.Facture);
								}

								if (row1.Date == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.Date);
								}

								if (row1.Montant == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.Montant);
								}

								if (row1.Fournisseur1 == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.Fournisseur1);
								}
	...
	public static void main(String[] args) {
		final Depenses_Fournisseur2 Depenses_Fournisseur2Class = new Depenses_Fournisseur2();

		int exitCode = Depenses_Fournisseur2Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Depenses_Fournisseur2.class.getClassLoader()
					.getResourceAsStream("pi_basana/depenses_fournisseur2_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Depenses_Fournisseur2.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Depenses_Fournisseur2");
		}
...
/************************************************************************************************
 * 59856 characters generated by Talend Open Studio for Data Integration on the
 * 9 février 2026 à 21:56:11 CET
 ************************************************************************************************/