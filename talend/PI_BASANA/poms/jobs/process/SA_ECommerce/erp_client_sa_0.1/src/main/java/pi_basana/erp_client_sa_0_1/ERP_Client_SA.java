...
package pi_basana.erp_client_sa_0_1;
 ...
 * @status
 */
public class ERP_Client_SA implements TalendJob {
	...
	private final String jobName = "ERP_Client_SA";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ERP_Client_SA.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ERP_Client_SA.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_ERP_Client_SA = new byte[0];
		static byte[] commonByteArray_PI_BASANA_ERP_Client_SA = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_ERP_Client_SA.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_ERP_Client_SA.length == 0) {
						commonByteArray_PI_BASANA_ERP_Client_SA = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_ERP_Client_SA = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_ERP_Client_SA, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_ERP_Client_SA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_ERP_Client_SA, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_ERP_Client_SA, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_ERP_Client_SA) {
				...
				try {
					...
					this.Date_Inscription = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Date_Inscription, dos);
		...
		public String toString() {
			...
			sb.append(",Date_Inscription=" + Date_Inscription);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:vHB5wLZfhGHSlrgzl/CVdrALUzUdg8He7Og+qQC453qNaAIP");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "ERP_Client_SA";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ERP_Client_SA";
				}
				int count_tDBOutput_1 = 0;

				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([ID_Client] INT ,[Nom_Client] VARCHAR(255)  ,[Adresse] VARCHAR(255)  ,[Type_Client] VARCHAR(255)  ,[Date_Inscription] VARCHAR(2552)  ,[Notes] VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([ID_Client],[Nom_Client],[Adresse],[Type_Client],[Date_Inscription],[Notes]) VALUES (?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:tGLHksKcCx2vICk0EwseX8tJKEGQi3esvgJbng==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/eree/Desktop/wetransfer_artisanat-zip_2026-01-21_0929/artisanat/artisanat/Erp Sougui Model EXCEL.xlsx";
				...
				try {
					...
					if (sheetList_tFileInputExcel_1.size() > 0) {
						...
						int begin_line_tFileInputExcel_1 = 17;
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Nom_Client = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Type_Client";

									row1.Type_Client = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Type_Client = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Date_Inscription";

									row1.Date_Inscription = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Date_Inscription = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Notes = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Notes = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.Nom_Client == null) {
									...
									pstmt_tDBOutput_1.setString(2, row1.Nom_Client);
								}

								if (row1.Adresse == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.Adresse);
								}

								if (row1.Type_Client == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.Type_Client);
								}

								if (row1.Date_Inscription == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.Date_Inscription);
								}

								if (row1.Notes == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, row1.Notes);
								}
	...
	public static void main(String[] args) {
		final ERP_Client_SA ERP_Client_SAClass = new ERP_Client_SA();

		int exitCode = ERP_Client_SAClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ERP_Client_SA.class.getClassLoader()
					.getResourceAsStream("pi_basana/erp_client_sa_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ERP_Client_SA.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ERP_Client_SA");
		}
...
/************************************************************************************************
 * 61968 characters generated by Talend Open Studio for Data Integration on the
 * 10 février 2026 à 00:15:55 CET
 ************************************************************************************************/