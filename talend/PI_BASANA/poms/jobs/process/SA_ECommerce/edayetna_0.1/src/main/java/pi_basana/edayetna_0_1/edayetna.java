...
package pi_basana.edayetna_0_1;
 ...
 * @status
 */
public class edayetna implements TalendJob {
	...
	private final String jobName = "edayetna";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(edayetna.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_edayetna = new byte[0];
		static byte[] commonByteArray_PI_BASANA_edayetna = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_edayetna.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_edayetna.length == 0) {
						commonByteArray_PI_BASANA_edayetna = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_edayetna = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_edayetna, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_edayetna, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_edayetna, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_edayetna, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_edayetna) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ehhH1XJcPx7mMt4wGZDmBZapWtDB+PVxhMuqXTZ5KDgZDomD");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "produits_edayetna_webscraping";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "produits_edayetna_webscraping";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([titre],[categorie],[prix_avant],[prix_apres],[promotion],[url],[image]) VALUES (?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:XwBWicGbNYAMan7qKc4bGkeSQFH2wyzCrT2dMQ==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/eree/Desktop/wetransfer_artisanat-zip_2026-01-21_0929/artisanat/artisanat/produits_edaytna.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "prix_avant";

									row1.prix_avant = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.prix_avant = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "prix_apres";

									row1.prix_apres = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.prix_apres = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "promotion";

									row1.promotion = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.promotion = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.categorie == null) {
									...
									pstmt_tDBOutput_1.setString(2, row1.categorie);
								}

								if (row1.prix_avant == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.prix_avant);
								}

								if (row1.prix_apres == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.prix_apres);
								}

								if (row1.promotion == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.promotion);
								}

								if (row1.url == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, row1.url);
								}
	...
	public static void main(String[] args) {
		final edayetna edayetnaClass = new edayetna();

		int exitCode = edayetnaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = edayetna.class.getClassLoader()
					.getResourceAsStream("pi_basana/edayetna_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = edayetna.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : edayetna");
		}
...
/************************************************************************************************
 * 60935 characters generated by Talend Open Studio for Data Integration on the
 * 28 février 2026 à 15:54:29 CET
 ************************************************************************************************/