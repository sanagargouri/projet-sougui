...
package pi_basana.produits_sougui_webscrapping_0_1;
...
/**
 * Job: produits_sougui_webscrapping Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class produits_sougui_webscrapping implements TalendJob {
	...
	private final String jobName = "produits_sougui_webscrapping";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					produits_sougui_webscrapping.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(produits_sougui_webscrapping.this,
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_produits_sougui_webscrapping = new byte[0];
		static byte[] commonByteArray_PI_BASANA_produits_sougui_webscrapping = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_produits_sougui_webscrapping.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_produits_sougui_webscrapping.length == 0) {
						commonByteArray_PI_BASANA_produits_sougui_webscrapping = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_produits_sougui_webscrapping = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_produits_sougui_webscrapping, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_produits_sougui_webscrapping, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_produits_sougui_webscrapping, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_produits_sougui_webscrapping, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_produits_sougui_webscrapping) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:L1C/hKiuL7sCfMOcMx4sAZNupZ7gbdFXDq5H3/vETgZQnt0U");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "produits_sougui_webscraping";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "produits_sougui_webscraping";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([titre],[url],[pack],[prix_avant_promo],[prix_apres_promo],[categories],[image],[en_promotion],[sku]) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:QURWGCd+aD1FAhwJKIwCbY8So7I6aA5GZTLpyQ==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/eree/Desktop/wetransfer_artisanat-zip_2026-01-21_0929/artisanat/artisanat/produits_final.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "titre";

									row1.titre = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.titre = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "pack";

									row1.pack = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.pack = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "prix_avant_promo";

									row1.prix_avant_promo = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "prix_apres_promo";

									row1.prix_apres_promo = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "en_promotion";

									row1.en_promotion = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.titre == null) {
									...
									pstmt_tDBOutput_1.setString(1, row1.titre);
								}

								if (row1.url == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.url);
								}

								if (row1.pack == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.pack);
								}

								if (row1.prix_avant_promo == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.prix_avant_promo);
								}

								if (row1.prix_apres_promo == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.prix_apres_promo);
								}

								if (row1.categories == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, row1.categories);
								}

								if (row1.image == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, row1.image);
								}

								if (row1.en_promotion == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, row1.en_promotion);
								}

								if (row1.sku == null) {
									pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(9, row1.sku);
								}
	...
	public static void main(String[] args) {
		final produits_sougui_webscrapping produits_sougui_webscrappingClass = new produits_sougui_webscrapping();

		int exitCode = produits_sougui_webscrappingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = produits_sougui_webscrapping.class.getClassLoader().getResourceAsStream(
					"pi_basana/produits_sougui_webscrapping_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = produits_sougui_webscrapping.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : produits_sougui_webscrapping");
		}
...
/************************************************************************************************
 * 63644 characters generated by Talend Open Studio for Data Integration on the
 * 28 février 2026 à 13:29:47 CET
 ************************************************************************************************/