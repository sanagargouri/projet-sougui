...
package pi_basana.siteweb_produits_resume_0_1;
...
/**
 * Job: SiteWeb_Produits_Resume Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class SiteWeb_Produits_Resume implements TalendJob {
	...
	private final String jobName = "SiteWeb_Produits_Resume";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SiteWeb_Produits_Resume.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SiteWeb_Produits_Resume.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_SiteWeb_Produits_Resume = new byte[0];
		static byte[] commonByteArray_PI_BASANA_SiteWeb_Produits_Resume = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_SiteWeb_Produits_Resume.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_SiteWeb_Produits_Resume.length == 0) {
						commonByteArray_PI_BASANA_SiteWeb_Produits_Resume = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_SiteWeb_Produits_Resume = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_SiteWeb_Produits_Resume, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_SiteWeb_Produits_Resume, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_SiteWeb_Produits_Resume, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_SiteWeb_Produits_Resume, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_SiteWeb_Produits_Resume) {

				try {

					int length = 0;

					this.Indicateur = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Indicateur, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("Indicateur=" + Indicateur);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ctggbCTk58YMFnirYci5loQDTCpFvJUu+9u2VOLzx9iffLTS");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "SiteWeb_Produits_Resume_SA";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "SiteWeb_Produits_Resume_SA";
				}
				int count_tDBOutput_1 = 0;

				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute(
							"CREATE TABLE [" + tableName_tDBOutput_1 + "]([Indicateur] VARCHAR(255)  ,[Valeur] INT )");
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Indicateur],[Valeur]) VALUES (?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:48/+vHwQyfKOANXw5SIVX8WlhXUo9DeKlzA4bg==");
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "Resume", false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "Indicateur";

									row1.Indicateur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Indicateur = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.Valeur = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.Indicateur == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, row1.Indicateur);
								}

								if (row1.Valeur == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(2, row1.Valeur);
								}
	...
	public static void main(String[] args) {
		final SiteWeb_Produits_Resume SiteWeb_Produits_ResumeClass = new SiteWeb_Produits_Resume();

		int exitCode = SiteWeb_Produits_ResumeClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SiteWeb_Produits_Resume.class.getClassLoader().getResourceAsStream(
					"pi_basana/siteweb_produits_resume_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SiteWeb_Produits_Resume.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SiteWeb_Produits_Resume");
		}
...
/************************************************************************************************
 * 58022 characters generated by Talend Open Studio for Data Integration on the
 * 10 février 2026 à 11:14:51 CET
 ************************************************************************************************/