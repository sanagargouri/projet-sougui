...
package pi_basana.ca_par_mois_2023_0_1;
...
/**
 * Job: CA_Par_Mois_2023 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class CA_Par_Mois_2023 implements TalendJob {
	...
	private final String jobName = "CA_Par_Mois_2023";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CA_Par_Mois_2023.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CA_Par_Mois_2023.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_CA_Par_Mois_2023 = new byte[0];
		static byte[] commonByteArray_PI_BASANA_CA_Par_Mois_2023 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_CA_Par_Mois_2023.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_CA_Par_Mois_2023.length == 0) {
						commonByteArray_PI_BASANA_CA_Par_Mois_2023 = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_CA_Par_Mois_2023 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_CA_Par_Mois_2023, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_CA_Par_Mois_2023, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_CA_Par_Mois_2023, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_CA_Par_Mois_2023, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_CA_Par_Mois_2023) {
				...
				try {
					...
					this.CA = readString(dis);

					this.Pourcentage = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.CA, dos);

				// String

				writeString(this.Pourcentage, dos);
		...
		public String toString() {
			...
			sb.append("Mois=" + Mois);
			sb.append(",CA=" + CA);
			sb.append(",Pourcentage=" + Pourcentage);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Ggm3zjyAj5NnIYfWPL5ENkYBnpYW5YKxhiZ+iUvRBdvbuOfT");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "CA_Par_Mois_2023";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "CA_Par_Mois_2023";
				}
				int count_tDBOutput_1 = 0;

				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
							+ "]([Mois] VARCHAR(255)  ,[CA] VARCHAR(255)  ,[Pourcentage] VARCHAR(255)  )");
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Mois],[CA],[Pourcentage]) VALUES (?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:w8I6dyQk2kyIushph0Wt5+rOQUizrwYDFLz/bg==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/eree/Desktop/wetransfer_artisanat-zip_2026-01-21_0929/artisanat/artisanat/Bilan/CA par mois.xlsx";
				...
				try {
					...
					sheetList_tFileInputExcel_1
							.addAll(regexUtil_tFileInputExcel_1.getSheets(workbook_tFileInputExcel_1, "2023", false));
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "CA";

									row1.CA = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.CA = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Pourcentage";

									row1.Pourcentage = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Pourcentage = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.Mois == null) {
									...
									pstmt_tDBOutput_1.setString(1, row1.Mois);
								}

								if (row1.CA == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.CA);
								}

								if (row1.Pourcentage == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.Pourcentage);
								}
	...
	public static void main(String[] args) {
		final CA_Par_Mois_2023 CA_Par_Mois_2023Class = new CA_Par_Mois_2023();

		int exitCode = CA_Par_Mois_2023Class.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CA_Par_Mois_2023.class.getClassLoader()
					.getResourceAsStream("pi_basana/ca_par_mois_2023_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CA_Par_Mois_2023.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : CA_Par_Mois_2023");
		}
...
/************************************************************************************************
 * 57495 characters generated by Talend Open Studio for Data Integration on the
 * 9 février 2026 à 17:52:56 CET
 ************************************************************************************************/