...
package pi_basana.sa_suivi_achat_0_1;
 ...
 * @status
 */
public class SA_suivi_Achat implements TalendJob {
	...
	private final String jobName = "SA_suivi_Achat";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SA_suivi_Achat.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SA_suivi_Achat.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PI_BASANA_SA_suivi_Achat = new byte[0];
		static byte[] commonByteArray_PI_BASANA_SA_suivi_Achat = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PI_BASANA_SA_suivi_Achat.length) {
					if (length < 1024 && commonByteArray_PI_BASANA_SA_suivi_Achat.length == 0) {
						commonByteArray_PI_BASANA_SA_suivi_Achat = new byte[1024];
					} else {
						commonByteArray_PI_BASANA_SA_suivi_Achat = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PI_BASANA_SA_suivi_Achat, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_SA_suivi_Achat, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PI_BASANA_SA_suivi_Achat, 0, length);
				strReturn = new String(commonByteArray_PI_BASANA_SA_suivi_Achat, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PI_BASANA_SA_suivi_Achat) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:cdgXxik7M18XWkD/qhoVx4+Niceci6eCkaPnyRUbgYItSzYJ");
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
								+ "]([Societe] VARCHAR(255)  ,[Nom_du_Fournisseur] VARCHAR(255)  ,[N_Facture] VARCHAR(255)  ,[Date_de_facture] VARCHAR(255)  ,[Montant_HT] VARCHAR(255)  ,[Taux_de_TVA] VARCHAR(255)  ,[Timbre] VARCHAR(255)  ,[Montant_de_la_TVA] VARCHAR(255)  ,[FODEC] VARCHAR(255)  ,[Montant_TTC] VARCHAR(255)  ,[Retenue] VARCHAR(255)  ,[Versements_effectues_par_SOUGUI] VARCHAR(255)  ,[Reste_du] VARCHAR(255)  ,[Action_a_effectuer] VARCHAR(255)  ,[Date_de_paiement_total_de_la_facture] VARCHAR(255)  ,[mode_de_reglement] VARCHAR(255)  ,[Date_de_la_premiere_relance] VARCHAR(255)  ,[Date_de_la_deuxieme_relance] VARCHAR(255)  ,[Penalite_et_majoration_de_paiement] VARCHAR(255)  ,[Commentaire] VARCHAR(255)  )");
					}
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Societe],[Nom_du_Fournisseur],[N_Facture],[Date_de_facture],[Montant_HT],[Taux_de_TVA],[Timbre],[Montant_de_la_TVA],[FODEC],[Montant_TTC],[Retenue],[Versements_effectues_par_SOUGUI],[Reste_du],[Action_a_effectuer],[Date_de_paiement_total_de_la_facture],[mode_de_reglement],[Date_de_la_premiere_relance],[Date_de_la_deuxieme_relance],[Penalite_et_majoration_de_paiement],[Commentaire]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:bfvjt1nE960zkFeDkQ3DH/9cc+E55P84EysR3w==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/eree/Desktop/wetransfer_artisanat-zip_2026-01-21_0929/artisanat/artisanat/etat achats ventes 2023-2024.xlsx";
				...
				try {
					...
					if (sheetList_tFileInputExcel_1.size() > 0) {
						...
						Integer lastColumn_tFileInputExcel_1 = 21;
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "Societe";

									row1.Societe = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Societe = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Nom_du_Fournisseur";

									row1.Nom_du_Fournisseur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Nom_du_Fournisseur = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "N_Facture";

									row1.N_Facture = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.N_Facture = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Date_de_facture";

									row1.Date_de_facture = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Date_de_facture = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Montant_HT";

									row1.Montant_HT = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Taux_de_TVA";

									row1.Taux_de_TVA = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Taux_de_TVA = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Timbre";

									row1.Timbre = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Timbre = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Montant_de_la_TVA";

									row1.Montant_de_la_TVA = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Montant_de_la_TVA = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "FODEC";

									row1.FODEC = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.FODEC = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Montant_TTC";

									row1.Montant_TTC = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Retenue";

									row1.Retenue = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Retenue = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Versements_effectues_par_SOUGUI";

									row1.Versements_effectues_par_SOUGUI = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Versements_effectues_par_SOUGUI = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Reste_du";

									row1.Reste_du = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Reste_du = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Action_a_effectuer";

									row1.Action_a_effectuer = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Action_a_effectuer = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Date_de_paiement_total_de_la_facture";

									row1.Date_de_paiement_total_de_la_facture = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Date_de_paiement_total_de_la_facture = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "mode_de_reglement";

									row1.mode_de_reglement = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.mode_de_reglement = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Date_de_la_premiere_relance";

									row1.Date_de_la_premiere_relance = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Date_de_la_premiere_relance = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Date_de_la_deuxieme_relance";

									row1.Date_de_la_deuxieme_relance = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Date_de_la_deuxieme_relance = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Penalite_et_majoration_de_paiement";

									row1.Penalite_et_majoration_de_paiement = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Penalite_et_majoration_de_paiement = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.Societe == null) {
									...
									pstmt_tDBOutput_1.setString(1, row1.Societe);
								}

								if (row1.Nom_du_Fournisseur == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.Nom_du_Fournisseur);
								}

								if (row1.N_Facture == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.N_Facture);
								}

								if (row1.Date_de_facture == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.Date_de_facture);
								}

								if (row1.Montant_HT == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.Montant_HT);
								}

								if (row1.Taux_de_TVA == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, row1.Taux_de_TVA);
								}

								if (row1.Timbre == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, row1.Timbre);
								}

								if (row1.Montant_de_la_TVA == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, row1.Montant_de_la_TVA);
								}

								if (row1.FODEC == null) {
									pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(9, row1.FODEC);
								}

								if (row1.Montant_TTC == null) {
									pstmt_tDBOutput_1.setNull(10, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(10, row1.Montant_TTC);
								}

								if (row1.Retenue == null) {
									pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(11, row1.Retenue);
								}

								if (row1.Versements_effectues_par_SOUGUI == null) {
									pstmt_tDBOutput_1.setNull(12, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(12, row1.Versements_effectues_par_SOUGUI);
								}

								if (row1.Reste_du == null) {
									pstmt_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(13, row1.Reste_du);
								}

								if (row1.Action_a_effectuer == null) {
									pstmt_tDBOutput_1.setNull(14, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(14, row1.Action_a_effectuer);
								}

								if (row1.Date_de_paiement_total_de_la_facture == null) {
									pstmt_tDBOutput_1.setNull(15, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(15, row1.Date_de_paiement_total_de_la_facture);
								}

								if (row1.mode_de_reglement == null) {
									pstmt_tDBOutput_1.setNull(16, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(16, row1.mode_de_reglement);
								}

								if (row1.Date_de_la_premiere_relance == null) {
									pstmt_tDBOutput_1.setNull(17, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(17, row1.Date_de_la_premiere_relance);
								}

								if (row1.Date_de_la_deuxieme_relance == null) {
									pstmt_tDBOutput_1.setNull(18, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(18, row1.Date_de_la_deuxieme_relance);
								}

								if (row1.Penalite_et_majoration_de_paiement == null) {
									pstmt_tDBOutput_1.setNull(19, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(19, row1.Penalite_et_majoration_de_paiement);
								}

								if (row1.Commentaire == null) {
									pstmt_tDBOutput_1.setNull(20, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(20, row1.Commentaire);
								}
	...
	public static void main(String[] args) {
		final SA_suivi_Achat SA_suivi_AchatClass = new SA_suivi_Achat();

		int exitCode = SA_suivi_AchatClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SA_suivi_Achat.class.getClassLoader()
					.getResourceAsStream("pi_basana/sa_suivi_achat_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SA_suivi_Achat.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : SA_suivi_Achat");
		}
...
/************************************************************************************************
 * 78633 characters generated by Talend Open Studio for Data Integration on the
 * 9 février 2026 à 01:38:40 CET
 ************************************************************************************************/